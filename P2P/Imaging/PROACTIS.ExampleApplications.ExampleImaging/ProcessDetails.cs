...
namespace PROACTIS.ExampleApplications.ExampleImaging
{
    internal class ProcessDetails
    {
        ...
        private ProcessDetails(string documentDetailsXML)
        {
            ...
            this.DocumentGUID = dom.DocumentElement.SelectSingleNode("grs:DocumentGUID", nsmgr).InnerText;
        ...
        internal static ProcessDetails FromXML(string documentDetailsXML)
        {
            return new ProcessDetails(documentDetailsXML);
        }
    }
}